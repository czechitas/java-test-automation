...
> Low-code automation practice
>
> 🧠 Tip: Otevři/zavři jednotlivé sekce přes kliknutí na jejich souhrn.
>
...
<details open>
<summary><strong>🧭 Navigace</strong></summary>

1. Napište navigaci, která přejde do sekce **Pro rodiče -> Návody a formuláře**.
2. Napište navigaci, která přejde do sekce **Pro učitelé -> Objednávka pro MŠ/ZŠ** a jako
objednávanou službu v dolní části obrazovky zvolí **Příměstský tábor**.
3. Napište navigaci, která postupně projde všechny sekce horního veřejného menu.
4. Napište navigaci, která přejde do sekce **Pro učitelé -> Objednávka pro MŠ/ZŠ** a do
...
vytvářet pomocí kódu testů? Zamyslete se nad tím, jak by se dali uživatelé vytvářet
v testech?
...
<details open>
<summary><strong>✅ Asertace</strong></summary>
...
registraci.
3. V aplikaci se přihlašte pod Vámi založeným uživatel a ručně si vytvořte libovolnou
přihlášku.
...
<details open>
<summary><strong>🔁 Opakování (Navigace)</strong></summary>
...
pole **Počet dětí** vyplní libovolný počet dětí. (Bonus: ověřte asertací vhodně zvolené části testu.)

</details>

<details open>
<summary><strong>🔍 Opakování (Asertace)</strong></summary>

1. Napište test, který se přihlásí do aplikace, přejde pomocí horního menu do sekce **Přihlášky** a
ověří, že v tabulce přihlášek jsou sloupce pojmenované **Jméno** a **Kategorie**.

</details>

<details open>
<summary><strong>🧪🚀 Komplexnější testy</strong></summary>
...
2. Vytvořte ručně přihlášku, kde jako příjmení žáka uveďte **Tester001**. (Toto jméno by v rámci
...
5. Prodiskutujte s lektorem nebo kouči, jak se dá v Java programu uložit hodnota k
opakovanému použití.
6. Přihlaste se pod jedním z Vámi založených uživatelů a vytvořte přihlášku pro žáka s náhodně
